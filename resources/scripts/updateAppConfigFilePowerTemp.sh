...
# New code as per Rich's recommendation
#git add $Application/$Application-3DSPACE-$Environment/app/appConfig.json
#git commit -m "updating appConfig for $Application/$Application-3DSPACE-$Environment/app/appConfig.json"
